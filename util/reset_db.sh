...
psql -f util/setup_1_schema.sql -p 5450 -h localhost -U postgres db_subsetter_origin
psql -f util/setup_2_data.sql -p 5450 -h localhost -U postgres db_subsetter_origin
psql -f util/setup_3_indices.sql -p 5450 -h localhost -U postgres db_subsetter_origin

pg_dump -h localhost -p 5450 -U postgres --section=pre-data db_subsetter_origin | psql -h localhost -p 5451 -U postgres db_subsetter_target