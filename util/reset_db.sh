...
psql -f util/setup_1_pre_data.sql -p 5450 -h localhost -U postgres db_subsetter_origin -v ON_ERROR_STOP=1
psql -f util/setup_2_data.sql -p 5450 -h localhost -U postgres db_subsetter_origin -v ON_ERROR_STOP=1
psql -f util/setup_3_post_data.sql -p 5450 -h localhost -U postgres db_subsetter_origin -v ON_ERROR_STOP=1
