package trw.dbsubsetter.integration
...
/*
 * The large amount of static data needed to set this trw.dbsubsetter.unit test up (data a lot of which is not even
 * directly used by the trw.dbsubsetter.unit test itself) shows that our implementation should eventually be cleaned up
 */
