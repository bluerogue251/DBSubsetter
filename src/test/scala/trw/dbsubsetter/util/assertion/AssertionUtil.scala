package trw.dbsubsetter.util.assertion
...
trait AssertionUtil extends Assertions {
  ...
  protected def targetSingleThreadedSlick: JdbcBackend#DatabaseDef

  protected def targetAkkaStreamsSlick: JdbcBackend#DatabaseDef
