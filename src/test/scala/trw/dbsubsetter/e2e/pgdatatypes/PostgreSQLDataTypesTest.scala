package trw.dbsubsetter.e2e.pgdatatypes
...
class PostgreSQLDataTypesTest extends AbstractPostgresqlEndToEndTest {
  ...
  override protected def prepareOriginDDL(): Unit = {
    val ddlFile = new File("./src/test/scala/trw.dbsubsetter.e2e/pgdatatypes/ddl.sql")
    (ddlFile #> originPsqlCommand).!!
  }

  override protected def prepareOriginDML(): Unit = {
    val dmlFile = new File("./src/test/scala/trw.dbsubsetter.e2e/pgdatatypes/dml.sql")
