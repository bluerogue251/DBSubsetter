package trw.dbsubsetter.e2e.mysqldatatypes
...
class MySqlDataTypesTest extends AbstractMysqlEndToEndTest with AssertionUtil {
  ...
  override protected def prepareOriginDDL(): Unit = {
    val ddlFile = new File("./src/test/scala/trw.dbsubsetter.e2e/mysqldatatypes/ddl.sql")
    (ddlFile #> originMySqlCommand).!!
  }

  override protected def prepareOriginDML(): Unit = {
    val dmlFile = new File("./src/test/scala/trw.dbsubsetter.e2e/mysqldatatypes/dml.sql")
